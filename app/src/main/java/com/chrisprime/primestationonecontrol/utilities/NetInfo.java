...
public class NetInfo {
    ...
    @Override
    public int hashCode() {
        int ip_custom = prefs.getBoolean(KEY_IP_CUSTOM, DEFAULT_IP_CUSTOM) ? 1:0;
        ...
        int cidr_custom = prefs.getBoolean(KEY_CIDR_CUSTOM, DEFAULT_CIDR_CUSTOM) ? 1:0;
        int cidr = prefs.getString(KEY_CIDR, DEFAULT_CIDR).hashCode();
